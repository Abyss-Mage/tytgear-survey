...
export const PRODUCTS: ProductInfo[] = [
  {
    ...
    category: "Desk & Setup",
    description: "Compact precision mousepads ideal for tight desk setups or portable laptop gaming.",
  ...
  },
  {
    ...
    category: "Desk & Setup",
    description: "Extended large desk mats covering keyboard, mouse, and workspace with hybrid glide.",
