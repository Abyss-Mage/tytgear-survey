...
const RESPONSES_HEADERS = [
  "response_id", "survey_version", "timestamp_started", "timestamp_completed",
  "completion_time_seconds", "college_id", "college_name", "age", "respondent_type",
  "city", "state", "interests", "gaming_frequency", "platforms", "setup_type",
  "owned_products", "last_purchase", "recent_purchase", "recent_spend", "purchase_location",
  "purchase_drivers", "product_interest_small_mousepad", "product_interest_large_mousepad",
  "product_interest_desk_mat", "product_interest_desk_accessories", "product_interest_tapestry",
  "product_interest_wall_art", "product_interest_mobile_cover", "product_interest_apparel",
  "product_interest_bags", "product_interest_other", "top_products", "important_attributes",
  "purchase_problems", "designs_appealing", "design_most_likely_purchase",
  "design_most_likely_display", "design_purchase_drivers", "price_too_cheap",
  "price_good_deal", "price_expensive", "price_too_expensive", "tytgear_interest",
  "tytgear_trial_drivers", "discovery_channels", "content_preferences", "launch_offer",
  "purchase_intent", "contact_consent", "suspicious_response"
];

const LEADS_HEADERS = [
  "response_id", "timestamp", "college", "contact_method", "contact_value", "consent"
];
